...
export default function CustomOrdersBanner() {
  const waLink = `https://wa.me/${WHATSAPP_NUMBER}?text=Hi%20Lily%20%26%20Looms!%20I%20am%20interested%20in%20a%20custom%20crochet%20order.`
  ...
  return (
    <section id="custom-orders" className="custom-banner" aria-labelledby="custom-title">
      ...
      <div className="container custom-banner__content">
        ...
        <h2 className="custom-banner__title" id="custom-title">
          Have something special in mind?
        </h2>
        <p className="custom-banner__text">
          We create fully customised crochet pieces — your colours, your sizes,
          your designs, made just for you. Whether it's a one-of-a-kind gift,
        ...
        <a
          ...
          className="btn btn-whatsapp custom-banner__cta"
        >
